...
from lib.models.units import *
from lib.models.utils import _parse_ksize
...
class GENetBuilder:
    ...
    def __init__(self, channel_multiplier=1.0, channel_divisor=8, channel_min=None,
                 ...
                 verbose=False, add_dw=False, block_type='ir', change_se=False, change_ir_se=False, dilation_method=None):
        # custom DIY
